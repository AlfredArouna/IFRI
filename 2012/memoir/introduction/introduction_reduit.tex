...
\end{itemize}
%La réactivité permet au système de supervision d'être capable de diagnostiquer et bien souvent de réparer seule les pannes ou d'envoyer une notification au concerné par la gestion du réseau. La pro-activité permet au système de supervision vu sa vision  continue  du réseau d'anticiper sur les problèmes futurs.
...
%En effet, une vue graphique de la typologie du réseau est obligatoire pour les administrateurs pour pouvoir exécuter leur tâches quotidiennes : détection de la cause fondamentale d'un problème, analyse de trafic, détection des équipements en dysfonctionnement, détection des liens ou nœud de congestion, gestion des ressources du réseau, prévision et ajout de nouvel équipement dans le réseau, etc.
